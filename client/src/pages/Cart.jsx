...
const Cart = () => {
    ...
    const orderSummary = useMemo(() => {
        ...
        let tiffinFee = 0;
        // Flat delivery fee per individual custom tiffin line-item
        const customTiffinItems = cartItems.filter(item => item.type === 'single_tiffin');
        tiffinFee = customTiffinItems.length * DELIVERY_FEE_PER_SLOT;
    ...
    // WhatsApp checkout removed as per request
